...
import { useGetInfiniteAdminCustomerDeliveries } from 'src/hooks/api/useAdminCustomerDeliveries';
...
const CustomerDeliveries = ({ referenceId, type }) => {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useGetInfiniteAdminCustomerDeliveries(
      {
        id: referenceId,
        ...params
      },
