...
import { useGetInfinitePrefectures } from 'src/hooks/api/useAdminPrefectures'
import { loadMoreValidator } from 'src/@core/utils/helper'

const DropdownPrefectures = ({
  error,
  helperText,
  defaultValue = {},
  value = { id: '', name: '' },
  ...
  const {
    ...
    hasNextPage,
    isFetchingNextPage
  } = useGetInfinitePrefectures(params, {
    select: data => {
...
export default DropdownPrefectures
